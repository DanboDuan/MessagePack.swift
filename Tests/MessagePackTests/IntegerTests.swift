...
class IntegerTests: XCTestCase {
    ...
    func testPackNegFixint() {
        XCTAssertEqual(pack(.int8(-1)), Data([0xff]))
    }
    ...
    func testPackPosFixintSigned() {
        XCTAssertEqual(pack(.uint8(1)), Data([0x01]))
    }

    func testUnpackPosFixintSigned() {
        let unpacked = try? unpack(Data([0x01]))
        XCTAssertEqual(unpacked?.value, .int8(1))
        XCTAssertEqual(unpacked?.remainder.count, 0)
    }

    func testPackPosFixintUnsigned() {
        XCTAssertEqual(pack(.uint8(42)), Data([0x2a]))
    }
    ...
    func testPackUInt8() {
        XCTAssertEqual(pack(.uint8(0xff)), Data([0xcc, 0xff]))
    }
    ...
    func testPackUInt16() {
        XCTAssertEqual(pack(.uint16(0xffff)), Data([0xcd, 0xff, 0xff]))
    }
    ...
    func testPackUInt32() {
        XCTAssertEqual(pack(.uint32(0xffff_ffff)), Data([0xce, 0xff, 0xff, 0xff, 0xff]))
    }
    ...
    func testPackInt8() {
        XCTAssertEqual(pack(.int8(-0x7f)), Data([0xd0, 0x81]))
    }
    ...
    func testPackInt16() {
        XCTAssertEqual(pack(.int16(-0x7fff)), Data([0xd1, 0x80, 0x01]))
    }
    ...
    func testPackInt32() {
        XCTAssertEqual(pack(.int32(-0x1_0000)), Data([0xd2, 0xff, 0xff, 0x00, 0x00]))
    }
